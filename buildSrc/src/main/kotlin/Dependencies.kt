...
object Dependencies {
    ...
    const val androidxComposeRuntime = "androidx.compose:compose-runtime:${Versions.compose}"
    ...
    const val androidxUiFoundation = "androidx.ui:ui-foundation:${Versions.compose}"
    const val androidxUiAnimation = "androidx.ui:ui-animation:${Versions.compose}"
